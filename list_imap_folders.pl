...
# $Header: /mhub4/sources/imap-tools/list_imap_folders.pl,v 1.26 2015/12/10 05:48:58 rick Exp $
...
sub usage {
   ...
   print STDERR "To login via CRAM-MD5 specify host as host/user/password/CRAM-MD5\n";

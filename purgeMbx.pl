...
# $Header: /mhub4/sources/imap-tools/purgeMbx.pl,v 1.9 2015/12/24 22:25:13 rick Exp $
...
sub usage {
   ...
   print STDOUT "To use CRAM-MD5 for logins add /CRAM-MD5 like this:  -s server/user/password/CRAM-MD5\n";
   exit;
